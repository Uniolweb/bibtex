 ...
 *
 * Other source: (https://www.bibtex.com/f/month-field/)
 * Month can be:
 *
 ...
 * month = {February}
 *
 * 17/June/2005 - Mark Grimshaw:  month fields that have multiple dates
 *    (e.g. dec # " 5--9," or nov # " 29" # "--" # dec # " 2") are correctly parsed.
 */
class ParseMonth
{
    /**
     ...
     * @return array<int,string|bool> returns array [$startMonth, $this->startDay, $endMonth, $this->endDay]
     *
     * @todo use only string values, empty string instead of false (must be checked first with calling functions)
     */
