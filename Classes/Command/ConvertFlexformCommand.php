...
class ConvertFlexformCommand extends Command
{
    ...
    {
        $this->setDescription('Check integrity for container contact plugins');
        $this->setHelp('Command will ouptut only information about plugins with problems, use -v to show more verbose info with information about checked plugins');
